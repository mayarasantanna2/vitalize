...
try {
    ...
    require_post(true);
    if (!rate_limit('agenda', (string)$idUsuario, 60, 60)) responder(['erro'=>'Aguarde um minuto.'], 429);
    ...
    $tipo = text_input('tipo',20,true);
    $especialidade = text_input('especialidade',100,true);
    $medico = text_input('medico',150);
    $local = text_input('nome_local',150);
    $data = text_input('data',10,true);
    $horario = text_input('horario',5,true);
