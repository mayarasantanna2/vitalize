...
if (!function_exists('mb_strlen')) responderErro(503, 'A extensão mbstring não está disponível no servidor.');
if (mb_strlen($restricoes, 'UTF-8') > 500) responderErro(422, 'As restrições devem ter no máximo 500 caracteres.');

if (!function_exists('curl_init')) responderErro(503, 'A extensão cURL não está disponível no servidor.');
